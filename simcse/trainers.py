...
from transformers.trainer_pt_utils import (
    reissue_pt_warnings, get_parameter_names
)
...
class CLTrainer(Trainer):
    ...
    def evaluate(
        ...
        metrics = {"eval_stsb_spearman": stsb_spearman, "eval_sickr_spearman": sickr_spearman,
                   "eval_avg_sts": (stsb_spearman + sickr_spearman) / 2, "eval_align_loss": stsb_align_loss,
                   "eval_uniform_loss": stsb_uniform_loss}
    ...
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            optimizer_grouped_parameters = [
                {
                    "params": [p for n, p in self.model.named_parameters() if n in decay_parameters and 'fix' not in n],
                    "weight_decay": self.args.weight_decay,
                },
                {
                    "params": [p for n, p in self.model.named_parameters() if n not in decay_parameters and 'fix' not in n],
                    "weight_decay": 0.0,
                },
            ]
